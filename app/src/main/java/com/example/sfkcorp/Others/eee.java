...
import com.example.sfkcorp.OtherEbook.eeesem23;
import com.example.sfkcorp.OtherEbook.eeesem24;
import com.example.sfkcorp.OtherEbook.eeesem25;
import com.example.sfkcorp.OtherEbook.eeesem31;
import com.example.sfkcorp.OtherEbook.eeesem32;
import com.example.sfkcorp.OtherEbook.eeesem33;
...
public class eee extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdLoader adLoader = new AdLoader.Builder(this, "ca-app-pub-2940628810690757/3074979969")
        ...
        semo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.show(eee.this);
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        @Override
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(eee.this, csem21.class);
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(eee.this, cse2.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(eee.this, eeesem23.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(eee.this, eeesem24.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(eee.this, eeesem25.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(eee.this, eeesem31.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(eee.this, eeesem32.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(eee.this, eeesem33.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
    ...
    public void  setAds(){
        ...
        InterstitialAd.load(this,getString(R.string.inter11), adRequest,
