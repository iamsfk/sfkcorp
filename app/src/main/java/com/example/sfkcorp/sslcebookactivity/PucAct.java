...
public class PucAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // ec.setOnClickListener(this);
        ...
        AdLoader adLoader = new AdLoader.Builder(this, "ca-app-pub-2940628810690757/7071733590")
        ...
        Sem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.show(PucAct.this);
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        @Override
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(PucAct.this, Pcmb.class);
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(PucAct.this, commerce.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(PucAct.this, arts.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
    ...
    public void  setAds(){
        ...
        InterstitialAd.load(this,getString(R.string.inter15), adRequest,
