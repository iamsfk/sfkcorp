...
public class Bcaqueclass extends AppCompatActivity  {
        ...
        sem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.show(Bcaqueclass.this);
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        @Override
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Bcaqueclass.this, Ebookbca.class);
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Bcaqueclass.this, Ebookbca2.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Bcaqueclass.this, Ebookbca3.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Bcaqueclass.this, Ebookbca4.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Bcaqueclass.this, Ebookbca5.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Bcaqueclass.this, Ebookbca6.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
