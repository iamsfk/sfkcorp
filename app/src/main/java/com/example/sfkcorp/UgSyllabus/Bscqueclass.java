...
public class Bscqueclass extends AppCompatActivity  {
        ...
        sem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.show(Bscqueclass.this);
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        @Override
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Bscqueclass.this, Ebookbsc.class);
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Bscqueclass.this, Ebookbsc2.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Bscqueclass.this, Ebookbsc3.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Bscqueclass.this, Ebookbsc4.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Bscqueclass.this, Ebookbsc5.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Bscqueclass.this, Ebookbsc6.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
