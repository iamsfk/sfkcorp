...
public class Baqueclass extends AppCompatActivity  {
        ...
        sem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.show(Baqueclass.this);
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        @Override
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Baqueclass.this, EbookBa.class);
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Baqueclass.this, EbookBa2.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Baqueclass.this, EbookBa3.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Baqueclass.this, EbookBa4.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Baqueclass.this, EbookBa5.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
            ...
            public void onClick(View view) {
                if(mInterstitialAd!=null){
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            super.onAdDismissedFullScreenContent();
                            Intent intent = new Intent(Baqueclass.this, EbookBa6.class);
                            startActivity(intent);
                            mInterstitialAd = null;
                            setAds();
                        }
